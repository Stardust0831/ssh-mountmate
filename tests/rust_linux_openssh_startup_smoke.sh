...
grep -Fx "ssh = ssh -T -o BatchMode=yes -o PermitLocalCommand=no -o RemoteCommand=none -F ${ssh_config} local-openssh-a" "${rclone_config}"
grep -F '[local-openssh-b]' "${rclone_config}"
grep -Fx "ssh = ssh -T -o BatchMode=yes -o PermitLocalCommand=no -o RemoteCommand=none -F ${ssh_config} local-openssh-b" "${rclone_config}"
